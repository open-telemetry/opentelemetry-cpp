...
class OPENTELEMETRY_EXPORT_TYPE HttpCurlGlobalInitializer
{
private:
...
class OPENTELEMETRY_EXPORT_TYPE HttpClient;
...
class OPENTELEMETRY_EXPORT_TYPE HttpClient : public opentelemetry::ext::http::client::HttpClient
{
public:
