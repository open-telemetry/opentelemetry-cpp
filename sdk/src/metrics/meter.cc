...
{
  InstrumentDescriptor instrument_descriptor = {name.data(), description.data(), unit.data(),
...
// WritableMatricsStorage &Meter::RegisterMetricsStorage(InstrumentDescriptor
