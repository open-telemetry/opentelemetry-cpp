...
MeterProvider::MeterProvider(std::vector<std::unique_ptr<MeterExporter>> &&exporters,
    ...
    : context_{std::make_shared<MeterContext>(exporters, readers, views, resource)}
{}
