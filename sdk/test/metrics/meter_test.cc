...
TEST(Meter, RecordBatch)
{
  ...
  nostd::span<const nostd::shared_ptr<metrics_api::SynchronousInstrument<short>>> sinstrs{
      sinstr_arr};
  ...
  nostd::span<const nostd::shared_ptr<metrics_api::SynchronousInstrument<float>>> finstrs{
      finstr_arr};
  ...
  nostd::span<const nostd::shared_ptr<metrics_api::SynchronousInstrument<double>>> dinstrs{
      dinstr_arr};
