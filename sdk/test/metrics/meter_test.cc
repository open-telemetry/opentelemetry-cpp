...
TEST(Meter, RecordBatch)
{
  ...
  nostd::shared_ptr<metrics_api::SynchronousInstrument<short>> sinstr_arr[] = {scounter};
  short svalues_arr[] = {1};

  nostd::span<const nostd::shared_ptr<metrics_api::SynchronousInstrument<short>>> sinstrs {sinstr_arr};
  ...
  nostd::span<const nostd::shared_ptr<metrics_api::SynchronousInstrument<int>>> iinstrs {iinstr_arr};
  ...
  nostd::span<const nostd::shared_ptr<metrics_api::SynchronousInstrument<float>>> finstrs {finstr_arr};
  ...
  nostd::span<const nostd::shared_ptr<metrics_api::SynchronousInstrument<double>>> dinstrs {dinstr_arr};
