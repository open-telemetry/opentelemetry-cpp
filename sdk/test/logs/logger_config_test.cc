...
{
  static auto value = *instrumentation_scope::InstrumentationScope::Create(
      "test_scope_4", "0", "https://opentelemetry.io/schemas/v1.18.0", {attr1()});
  return value;
}
static instrumentation_scope::InstrumentationScope &test_scope_5()
{
  static auto value = *instrumentation_scope::InstrumentationScope::Create(
      "test_scope_5", "0", "https://opentelemetry.io/schemas/v1.18.0", {attr1(), attr2(), attr3()});
  return value;
}
...
static const std::array<instrumentation_scope::InstrumentationScope *, 5> &instrumentation_scopes()
{
