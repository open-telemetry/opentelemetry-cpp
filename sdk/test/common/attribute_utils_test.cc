...
TEST(TruncateAttributeValueByteLength, TruncatesStringVariant)
{
  opentelemetry::sdk::common::OwnedAttributeValue value{std::string("0123456789")};
  opentelemetry::sdk::common::TruncateAttributeValueByteLength(value, 5);
  EXPECT_EQ(opentelemetry::nostd::get<std::string>(value), "01234");
}

TEST(TruncateAttributeValueByteLength, TruncatesStringArrayVariant)
{
  opentelemetry::sdk::common::OwnedAttributeValue value{
      std::vector<std::string>{"aaaaaa", "bb", "cccc"}};
  opentelemetry::sdk::common::TruncateAttributeValueByteLength(value, 3);
  const auto &vec = opentelemetry::nostd::get<std::vector<std::string>>(value);
...
TEST(TruncateAttributeValueByteLength, TruncatesBytesVariant)
{
  opentelemetry::sdk::common::OwnedAttributeValue value{
      std::vector<uint8_t>{0x01, 0x02, 0x03, 0x04, 0x05}};
  opentelemetry::sdk::common::TruncateAttributeValueByteLength(value, 3);
  const auto &bytes = opentelemetry::nostd::get<std::vector<uint8_t>>(value);
...
TEST(TruncateAttributeValueByteLength, LeavesShorterValueAlone)
{
  opentelemetry::sdk::common::OwnedAttributeValue value{std::string("short")};
  opentelemetry::sdk::common::TruncateAttributeValueByteLength(value, 100);
  EXPECT_EQ(opentelemetry::nostd::get<std::string>(value), "short");
}

TEST(TruncateAttributeValueByteLength, LeavesNonStringTypesAlone)
{
  opentelemetry::sdk::common::OwnedAttributeValue int_value{static_cast<int64_t>(1234567890)};
  opentelemetry::sdk::common::TruncateAttributeValueByteLength(int_value, 1);
  EXPECT_EQ(opentelemetry::nostd::get<int64_t>(int_value), 1234567890);

  opentelemetry::sdk::common::OwnedAttributeValue double_value{3.14};
  opentelemetry::sdk::common::TruncateAttributeValueByteLength(double_value, 1);
  EXPECT_DOUBLE_EQ(opentelemetry::nostd::get<double>(double_value), 3.14);

  opentelemetry::sdk::common::OwnedAttributeValue bool_value{true};
  opentelemetry::sdk::common::TruncateAttributeValueByteLength(bool_value, 1);
  EXPECT_EQ(opentelemetry::nostd::get<bool>(bool_value), true);
}
