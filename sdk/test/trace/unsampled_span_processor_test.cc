...
{
public:
  explicit MockSpanExporter(std::vector<std::unique_ptr<SpanData>>* spans) 
    : spans_(spans) {}
...
{
  // Default options - should not export valid unsampled spans but should export invalid context spans
  BatchSpanProcessorOptions options;
