 ...
 */
    ...
    class HistogramAggregator: public Aggregator<HistogramAccumulation<T>>
    {
        ...
        public:
            ...
            HistogramAccumulation<T> Merge(HistogramAccumulation<T>& prev, HistogramAccumulation<T>& current ) noexcept override {
                return HistogramAccumulation<T>(boundaries_);

            }

            /** Returns a new delta aggregation by comparing two cumulative measurements.*/
            HistogramAccumulation<T> diff(HistogramAccumulation<T>& prev, HistogramAccumulation<T>& current) noexcept override {
                 return HistogramAccumulation<T>(boundaries_)
            }
            ...
            HistogramMetricsData<T> ToMetricData(
                ...
                HistogramMetricsData<T> metrics_data = {resource, instrumentation_library, instrument_descriptor };
