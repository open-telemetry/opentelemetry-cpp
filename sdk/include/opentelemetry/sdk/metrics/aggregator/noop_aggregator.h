...
{
public:
  NoopAccumulation<T> CreateAccumulation() noexcept override { return NoopAccumulation<T>(); }

  /** Returns the result of the merge of the given accumulations.*/
  NoopAccumulation<T> Merge(NoopAccumulation<T> &prev,
                            NoopAccumulation<T> &current) noexcept override
  {
    return SumAccumulation<T>();
  }

  /** Returns a new delta aggregation by comparing two cumulative measurements.*/
  NoopAccumulation<T> diff(NoopAccumulation<T> &prev,
                           NoopAccumulation<T> &current) noexcept override
  {
