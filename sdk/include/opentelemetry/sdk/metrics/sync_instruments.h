...
class OPENTELEMETRY_EXPORT_TYPE LongGauge : public Synchronous, public opentelemetry::metrics::Gauge<int64_t>
{
public:
...
class OPENTELEMETRY_EXPORT_TYPE DoubleGauge : public Synchronous, public opentelemetry::metrics::Gauge<double>
{
public:
