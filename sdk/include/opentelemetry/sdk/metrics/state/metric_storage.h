...
class MetricStorage
{
   ...
   */
  virtual MetricData &collect(CollectionInfo &collection_info,
                              std::vector<CollectorInfo> &collection_infos,
                              opentelemetry::sdk::resource::Resource &resource,
                              opentelemetry::sdk::instrumentationlibrary::InstrumentationLibraryInfo
                                  &instrumentationLibraryInfo,
                              opentelemetry::common::SystemTimestamp &start_epoch_nanos,
                              opentelemetry::common::SystemTimestamp &epoch_nanos) noexcept = 0;
}
}  // namespace metrics
}  // namespace sdk
