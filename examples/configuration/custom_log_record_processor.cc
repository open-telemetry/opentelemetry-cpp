...
{
  OTEL_INTERNAL_LOG_WARN("CustomLogRecordProcessor::OnEnd(): YOUR CODE HERE");
  auto unused = std::move(span);
}

bool CustomLogRecordProcessor::ForceFlush(std::chrono::microseconds /* timeout */) noexcept
{
  OTEL_INTERNAL_LOG_WARN("CustomLogRecordProcessor::ForceFlush(): YOUR CODE HERE");
  return false;
}

bool CustomLogRecordProcessor::Shutdown(std::chrono::microseconds /* timeout */) noexcept
{
  OTEL_INTERNAL_LOG_WARN("CustomLogRecordProcessor::Shutdown(): YOUR CODE HERE");
  return false;
}
