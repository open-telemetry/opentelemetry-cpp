...
{
  OTEL_INTERNAL_LOG_WARN("CustomPushMetricExporter::Export(): YOUR CODE HERE");
...
{
  OTEL_INTERNAL_LOG_WARN("CustomPushMetricExporter::GetAggregationTemporality(): YOUR CODE HERE");
...
{
  OTEL_INTERNAL_LOG_WARN("CustomPushMetricExporter::ForceFlush(): YOUR CODE HERE");
  return true;
}

bool CustomPushMetricExporter::Shutdown(std::chrono::microseconds /* timeout */) noexcept
{
  OTEL_INTERNAL_LOG_WARN("CustomPushMetricExporter::Shutdown(): YOUR CODE HERE");
  return true;
}
