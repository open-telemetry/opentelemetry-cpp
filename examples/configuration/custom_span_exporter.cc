...
opentelemetry::sdk::common::ExportResult CustomSpanExporter::Export(
    const opentelemetry::nostd::span<std::unique_ptr<opentelemetry::sdk::trace::Recordable>>
        & /* spans */) noexcept
{
  OTEL_INTERNAL_LOG_WARN("CustomSpanExporter::Export(): YOUR CODE HERE");
  return opentelemetry::sdk::common::ExportResult::kSuccess;
}

bool CustomSpanExporter::ForceFlush(std::chrono::microseconds /* timeout */) noexcept
{
  OTEL_INTERNAL_LOG_WARN("CustomSpanExporter::ForceFlush(): YOUR CODE HERE");
  return false;
}

bool CustomSpanExporter::Shutdown(std::chrono::microseconds /* timeout */) noexcept
{
  OTEL_INTERNAL_LOG_WARN("CustomSpanExporter::Shutdown(): YOUR CODE HERE");
  return false;
}
