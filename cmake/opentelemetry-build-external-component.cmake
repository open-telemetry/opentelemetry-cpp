...
#  - OTELCPP_EXTERNAL_COMPONENT_PATH - Setting local paths of the external
# component. Multiple paths can be set by separating them with semicolons.

# Add custom vendor component from local path
# CMake option.
if(OTELCPP_EXTERNAL_COMPONENT_PATH)
  message(STATUS "Building external components from local path(s): ${OTELCPP_EXTERNAL_COMPONENT_PATH}")
  # Add custom component path to build tree and consolidate binary artifacts in
  # current project binary output directory.
  foreach(DIR IN LISTS OTELCPP_EXTERNAL_COMPONENT_PATH)
