...
function(_otel_find_package)
  ...
  if(DEFINED _THIRDPARTY_PACKAGE_SEARCH_MODES)
    list(GET _THIRDPARTY_PACKAGE_SEARCH_MODES 0 _SEARCH_MODE_SELECTED)
  endif()
  ...
  foreach(_SEARCH_MODE IN LISTS _THIRDPARTY_PACKAGE_SEARCH_MODES)
    ...
    if(${_THIRDPARTY_PACKAGE_NAME}_FOUND)
      set(_SEARCH_MODE_SELECTED ${_SEARCH_MODE})
      break()
    endif()
  endforeach()
  ...
  set("${_THIRDPARTY_PACKAGE_NAME}_SEARCH_MODE_SELECTED" ${_SEARCH_MODE_SELECTED} PARENT_SCOPE)
...
function(otel_add_thirdparty_package)
  ...
  if(NOT DEFINED ${_THIRDPARTY_PACKAGE_NAME}_VERSION)
    ...
    elseif(DEFINED _THIRDPARTY_VERSION_REGEX AND DEFINED _THIRDPARTY_VERSION_FILE)
      otel_parse_version_from_file(REGEX ${_THIRDPARTY_VERSION_REGEX} FILE ${_THIRDPARTY_VERSION_FILE} OUT_VERSION ${_THIRDPARTY_PACKAGE_NAME}_VERSION)
    endif()
  endif()
