...
if (UNIX AND NOT APPLE)
    ...
    elseif(NOT RPMCAPABLE MATCHES "NOTFOUND")
        ...
        list(APPEND CPACK_RPM_EXCLUDE_FROM_AUTO_FILELIST_ADDITION "${CMAKE_INSTALL_LIBDIR}/usr/lib64/cmake")
        list(APPEND CPACK_RPM_EXCLUDE_FROM_AUTO_FILELIST_ADDITION "${CMAKE_INSTALL_LIBDIR}/usr/lib64/pkgconfig")
...
elseif(WIN32)
    message(FATAL_ERROR "NuGet package generator not yet supported.")
endif()
