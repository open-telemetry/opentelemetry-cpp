  ...
  if (NOT opentelemetry-cpp_FIND_COMPONENTS)
    ...
    foreach(_COMPONENT IN LISTS opentelemetry-cpp_FIND_COMPONENTS)
        if(NOT ${_COMPONENT} IN_LIST OTEL_BUILT_COMPONENTS_LIST)
            message(ERROR " get_requested_components: Component `${_COMPONENT}` is not a supported component of the opentelemetry-cpp package. Built components include: ${OTEL_BUILT_COMPONENTS_LIST}")
            return()
        endif()
...
function(get_component_targets component_in targets_out)
  ...
  if(NOT ${component_in} IN_LIST OTEL_BUILT_COMPONENTS_LIST)
      message(ERROR " get_component_targets: Component `${component_in}` component is not a supported component of the opentelemetry-cpp package.")
  else()
