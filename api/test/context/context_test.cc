...
TEST(ContextTest, ContextSetValuesAcceptsStringViewContextValue)
{
  ...
  nostd::shared_ptr<context::Context> test_context = context::Context::CreateContext(string_view_test, context_value_test);
  nostd::shared_ptr<context::Context> foo_context = test_context->SetValue(string_view_test, context_value_test);
