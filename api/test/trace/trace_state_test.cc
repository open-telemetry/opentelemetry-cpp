...
TEST(TraceStateTest, MemorySafe)
{
  ...
  opentelemetry::nostd::string_view keys[kNumPairs]   = {key_string.substr(0,10), key_string.substr(10,10), key_string.substr(20,10)};
  opentelemetry::nostd::string_view values[kNumPairs] = {val_string.substr(0,10), val_string.substr(10,10), val_string.substr(20,10)};
