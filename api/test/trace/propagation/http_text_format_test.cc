...
{
    const std::map<std::string,std::string> carrier = {{"traceparent","why this is not working? f3577b34da6a3ce929d0e0e4736-00f067aa0ba902b7-01"}};
    ...
    EXPECT_EQ(carrier.size()-1,c2.size());
}
