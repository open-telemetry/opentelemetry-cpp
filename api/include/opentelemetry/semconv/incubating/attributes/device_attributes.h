 ...
 * Note: The device identifier MUST only be defined using the values outlined below. This value is
 ...
 * diligence.
 */
static const char *kDeviceId = "device.id";

/**
 * The name of the device manufacturer.
 * Note: The Android OS provides this field via <a
 ...
 */
static const char *kDeviceManufacturer = "device.manufacturer";

/**
 * The model identifier for the device.
 * Note: It's recommended this value represents a machine-readable version of the model identifier
 * rather than the market or consumer-friendly name of the device.
 */
static const char *kDeviceModelIdentifier = "device.model.identifier";

/**
 * The marketing name for the device model.
 * Note: It's recommended this value represents a human-readable version of the device model rather
 * than a machine-readable alternative.
 */
static const char *kDeviceModelName = "device.model.name";
