...
private:
  ...
  OPENTELEMETRY_DECLARE_API_SINGLETON static nostd::shared_ptr<TraceState> default_ts;
};

OPENTELEMETRY_DEFINE_API_SINGLETON nostd::shared_ptr<TraceState> TraceState::default_ts(
    new TraceState());
