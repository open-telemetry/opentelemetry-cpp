...
public:
  ...
  SpanContext(SpanContext&& ctx) : trace_id_(ctx.trace_id()), span_id_(ctx.span_id()), trace_flags_(ctx.trace_flags()), trace_state_(nostd::unique_ptr<TraceState>(&(ctx.trace_state()))) {}
  // TODO
  //
