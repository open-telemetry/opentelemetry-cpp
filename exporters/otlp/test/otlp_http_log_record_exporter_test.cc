...
#    ifdef ENABLE_ASYNC_EXPORT
  void ExportJsonIntegrationTestAsync()
  {
    ...
    auto provider = nostd::shared_ptr<sdk::logs::LoggerProvider>(new sdk::logs::LoggerProvider());
    sdk::logs::BarchLogRecordProcessorOptions options;
    ...
    provider->AddProcessor(std::unique_ptr<sdk::logs::LogRecordProcessor>(
        new sdk::logs::BarchLogRecordProcessor(std::move(exporter), options)));
...
#    endif
  ...
  void ExportBinaryIntegrationTest()
  {
    ...
    auto provider = nostd::shared_ptr<sdk::logs::LoggerProvider>(new sdk::logs::LoggerProvider());
    sdk::logs::BarchLogRecordProcessorOptions processor_options;
    ...
    provider->AddProcessor(std::unique_ptr<sdk::logs::LogRecordProcessor>(
        new sdk::logs::BarchLogRecordProcessor(std::move(exporter), processor_options)));
