...
TEST(OtlpHttpMetricExporterOptionsTest, KeepAliveDefaultsDisabled)
{
  OtlpHttpMetricExporterOptions opts{};
...
TEST(OtlpHttpMetricExporterOptionsTest, KeepAliveEnabledPropagatesIntoClientOptions)
{
  OtlpHttpMetricExporterOptions opts{};
...
TEST(OtlpHttpMetricExporterOptionsTest, KeepAliveDisabledPropagatesIntoClientOptions)
{
  OtlpHttpMetricExporterOptions opts{};
  std::shared_ptr<opentelemetry::sdk::common::ThreadInstrumentation> not_instrumented;
  OtlpHttpClientOptions client_opts(
