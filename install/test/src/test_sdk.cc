...
TEST(SdkInstallTest, SdkVersionCheck)
{
  ...
  EXPECT_GE(version_sdk::GetMajorVersion(), 0);
  EXPECT_GE(version_sdk::GetMinorVersion(), 0);
  EXPECT_GE(version_sdk::GetPatchVersion(), 0);
  EXPECT_NE(version_sdk::GetFullVersion(), "");
  EXPECT_NE(version_sdk::GetShortVersion(), "");
}
