...
EOF
  ...
  bazel $BAZEL_STARTUP_OPTIONS build --copt=-fno-exceptions $BAZEL_OPTIONS --build_tag_filters=-jaeger --test_tag_filters=-jaeger -- //... -//exporters/prometheus/...
  bazel $BAZEL_STARTUP_OPTIONS test --copt=-fno-exceptions $BAZEL_TEST_OPTIONS --build_tag_filters=-jaeger --test_tag_filters=-jaeger -- //... -//exporters/prometheus/...
  exit 0
