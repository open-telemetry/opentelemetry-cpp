...
DLL_DEPS = {
  ...
  Label("@//exporters/otlp:otlp_file_client"): None,
  Label("@//exporters/otlp:otlp_file_exporter"): None,
  Label("@//exporters/otlp:otlp_file_log_record_exporter"): None,
  Label("@//exporters/otlp:otlp_file_metric_exporter"): None,
